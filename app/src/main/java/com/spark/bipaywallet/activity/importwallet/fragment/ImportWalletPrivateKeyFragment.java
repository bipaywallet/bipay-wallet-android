 ...
 * 导入钱包--私钥
 */
public class ImportWalletPrivateKeyFragment extends ImportWalletBaseFragment {
    public static final String TAG = ImportWalletPrivateKeyFragment.class.getSimpleName();
...
//    CheckBox checkBox;
    ...
    public static ImportWalletPrivateKeyFragment getInstance() {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_import_wallet_private_key;
    }

    @Override
    protected void initData() {
        super.initData();
        etKey.setHint(R.string.activity_import_wallet_hint2);
    ...
    private void doImport() {
        ...
        if (StringUtils.isEmpty(nameStr, keyStr, passWordStr, confirmStr)) {
...
//                ToastUtils.showToast(getString(R.string.wallet_exist_warn));
                ...
                ToastUtils.showToast(getString(R.string.privkey_warn));
            }
        }
    }
